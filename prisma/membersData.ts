export const membersData = [
  ...
  },
  {
    ...
    location: [{ city: "Zakopane", street: "ul. Krupówki 33", postalCode: "34-500", latitude: 49.2992, longitude: 19.9496 }],
    reviews: [
      { reviewerEmail: "pawel@wp.pl", reviewerName: "Paweł", content: "Przepiękne widoki i super obsługa!", rating: 5 }
    ]
  },
  {
    ...
    location: [{ city: "Gdańsk", street: "ul. Długa 1", postalCode: "80-831", latitude: 54.352, longitude: 18.6466 }],
    reviews: []
  },
  {
    ...
    AnimalType: ["DOG"],
    location: [{ city: "Łódź", street: "ul. Piotrkowska 100", postalCode: "90-001", latitude: 51.7592, longitude: 19.455 }],
    reviews: [
      { reviewerEmail: "beata@wp.pl", reviewerName: "Beata", content: "Drogo, ale warto!", rating: 5 }
    ]
  },
  {
    ...
    AnimalType: ["CAT"],
    location: [{ city: "Toruń", street: "ul. Kopernika 7", postalCode: "87-100", latitude: 53.0138, longitude: 18.5984 }],
    reviews: [
      { reviewerEmail: "marta@wp.pl", reviewerName: "Marta", content: "Moja kotka była zachwycona.", rating: 4 }
    ]
  },
  {
    ...
    AnimalType: ["DOG", "CAT"],
    location: [{ city: "Lublin", street: "ul. Lipowa 2", postalCode: "20-400", latitude: 51.2465, longitude: 22.5684 }],
    reviews: []
  },
  {
    email: "citypet@wp.pl",
    ...
    AnimalType: ["DOG", "CAT"],
    location: [{ city: "Rzeszów", street: "ul. Rejtana 10", postalCode: "35-001", latitude: 50.0412, longitude: 21.9991 }],
    reviews: []
  },
  {
  ...
  maxPricePerNight: 85,
  minPricePerNight: 40,
  description: "Ekologiczny hotel dla zwierząt. 🌿<br>W pełni naturalne środowisko.",
  AnimalType: ["DOG", "OTHER"],
  location: [
    {
      city: "Białystok",
...
},
{
  ...
  minPricePerNight: 90,
  description: "Luksusowy hotel z opieką weterynaryjną 24/7. ✨<br>Dla najbardziej wymagających pupili.",
...
},
{
  ...
  minPricePerNight: 70,
  description: "Raj dla pupili w spokojnej okolicy. 🌴<br>Zielony ogród i indywidualna opieka.",
  AnimalType: ["DOG", "CAT"],
  location: [
    {
      city: "Łódź",
...
},
{
  ...
  maxPricePerNight: 110,
  minPricePerNight: 60,
  description: "Nowoczesny resort z przestrzenią do zabawy. 🏖️<br>Monitoring i codzienne raporty.",
  AnimalType: ["DOG"],
  location: [
    {
      city: "Poznań",
